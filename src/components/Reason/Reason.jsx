...
const Reason = () => {
  return (
    <section className={`section ${S.reason}`}>
      <div className="container">
        ...
        <div className={S.reason__contribution}>
          <p>
            Ваш внесок може зробити різницю між життям і смертю для наших
            бійців. Кожна гривня наближає нас до перемоги і допомагає захистити
            нашу Батьківщину.
            <br />
            <br />
            Разом ми сильні! Підтримайте 127-у бригаду і допоможіть їм
            виконувати свої обов&apos;язки з максимальною ефективністю.
          </p>
        </div>
        <SupportShareButtons />
      </div>
